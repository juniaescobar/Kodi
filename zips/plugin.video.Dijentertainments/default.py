...
ADDON = xbmcaddon.Addon(id='plugin.video.Dijentertainments')
...
def CATEGORIES():
        ...
        addLink('this is second listed item first directory','url',1,'https://raw.githubusercontent.com/djjohnnyb15/dij-entertainments/master/Directory/dij_entertainments_Directory.xml','hello everyone this is the description')
...
def Beginners(url):#  cause mode is empty in this one it will go back to first directory
        addDir('this is first listed item in second directory','url','','https://raw.githubusercontent.com/djjohnnyb15/dij-entertainments/master/Directory/dij_entertainments_Directory.xml','hello everyone this is the description')
        addDir('this is second listed item in second directory','url','','https://raw.githubusercontent.com/djjohnnyb15/dij-entertainments/master/Directory/dij_entertainments_Directory.xml','hello everyone this is the description')
